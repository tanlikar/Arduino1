...
int AnalogInput = 0;
int moistureThreshold = 0; //water till this threshold
int wateringThreshold = 0; // this threshold start water
int pumpFlag = 0;
...
String msg1, temp1, humi1, msg4, msg5;
char msg[50], temp[50], humi[50], msgSoil[50], msgMoistureState[50];
...
if(strcmp(topic,inTopic1)==0){ // strcmp return 0 if true
    ...
    msg5 = (String)pumpFlag;
    msg5.toCharArray(msgMoistureState,50);
    client.publish(outTopic3, msgMoistureState);
...
if(strcmp(topic,inTopic3)==0){ // strcmp return 0 if true
    moistureThreshold = message.toInt();
}

if(strcmp(topic,inTopic4)==0){ // strcmp return 0 if true
    wateringThreshold = message.toInt();
}
...
void loop() {
  ...
  client.loop();
   ...
   if(currentMillis - previousMillis >= interval) {
     ...
     Serial.print("Watering Threshold reading: ");
     Serial.println(wateringThreshold);
     
     if(AnalogInput >= moistureThreshold){
      pumpFlag = 0;
      digitalWrite(RELAY, LOW);
     }

     if(AnalogInput < wateringThreshold){
